<template>
    <div>
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">Snel</span>
              <img class="h-12 w-auto" src="https://apua-asea.org/wp-content/uploads/2023/01/snel.png" alt="">
            </a>
          </div>
          <div class="flex lg:hidden">
            <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700" @click="show = true">
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            <div class="relative">
              <button type="button" class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false" @click="show = !show">
                Product
              ...
              <transition class="transition ease-out duration-200">
                  <div v-if="show" class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                    <div class="p-4">
        ...
        <transition name="slide-fade">
            <div class="lg:hidden" role="dialog" aria-modal="true" v-if="show">
              ...
              <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                <div class="flex items-center justify-between">
                  <a href="#" class="-m-1.5 p-1.5">
                    ...
                    <img class="h-8 w-auto" src="https://upload.wikimedia.org/wikipedia/en/thumb/9/99/Logo-snel_ombre.svg/1500px-Logo-snel_ombre.svg.png" alt="">
                  </a>
